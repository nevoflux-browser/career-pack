...
| company | role | url | date | score | archetype | legitimacy | remote_policy | blockers | status | followup_due | report | pdf | outcome | notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
status taxonomy: evaluated → applied → responded → interview → offer
                                    ↘ rejected ↘ discarded ↘ ghosted ↘ skip
followup_due: YYYY-MM-DD the next follow-up is due (set when status→applied).
